...
Page({
    ...
    changeTab: function (e) {
        this.data.activeType = (this.data.activeType == true) ? false : true;
        //重置数据
        load.resetConfig();
        this.data.accounts = null;
        this.data.currentPage = 1;
        this.requestReturnGoods(e.currentTarget.id);

        this.setData({activeType: this.data.activeType});
    },
